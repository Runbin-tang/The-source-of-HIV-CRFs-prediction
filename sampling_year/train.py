...
#
def mlarmc(traindata, trainlabel, ttype):    
    parameters = {'threshold': np.arange(0.01,0.06,0.02) ,'vigilance': np.arange(0.93,1,0.02)}
    ...
    save_score('score/record',('mlaram',ttype,t,v,search_result.best_score_))
...
def puretrain(puredata,ttype):
    ...
    mlarmc(traindata1,trainlabel,ttype)
...
if __name__ == '__main__':
    ...
    for i in ttypee:
        for j in 'pure','crf':
            filename.append('./data/2revision'+i+j+'train.txt')
